...
class DB_Manager:
    ...
    def insert_project(self, data):
        sql = "INSERT OR IGNORE INTO projects (user_id, project_name, url, status_id) VALUES(?, ?, ?, ?)"  # Запиши сюда правильный SQL запрос
        self.__executemany(sql, data)
...
"""
    ...
    def delete_project_url(self, url):
        sql = "DELETE FROM projects WHERE url = ? "  # Запиши сюда правильный SQL запрос
        self.__executemany(sql, [(url,)])
...
if __name__ == "__main__":
    ...
    data = [
        (41244, "Quiz_bot", "youtube.com", 3),
        (24347, "Dnevnik", "youtube.com", 5),
        (91235, "Meme_generator", "youtube.com", 1),
        (55249, "Final_project", "youtube.com", 3),
        (13550, "Audio_bot", "youtube.com", 5),
        (65222, "Portfolio_bot", "youtube.com", 4),
        (51232, "Pokemon_bot", "youtube.com", 3),
    ]
    manager.insert_project(data)
    # manager.delete_project(12345, 1)
    # manager.delete_project_url("youtube.com")
